...
// Note: Replace with your own OAuth Client ID from Google Cloud Console
const OAUTH_CLIENT_ID =
  process.env.GOOGLE_OAUTH_CLIENT_ID || 'YOUR_GOOGLE_OAUTH_CLIENT_ID.apps.googleusercontent.com';

// OAuth Secret value used to initiate OAuth2Client class.
// Note: Replace with your own OAuth Client Secret from Google Cloud Console
// For installed applications, this can be embedded in source code, but it's better to use environment variables
