...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      // Stripe (test placeholders - these are not real keys)
      STRIPE_SK_LIVE: 'sk_live_TEST_PLACEHOLDER_xxxxxxxxxxxx',
      STRIPE_RK_LIVE: 'rk_live_TEST_PLACEHOLDER_xxxxxxxxxxxx',
      STRIPE_SK_TEST: 'sk_test_TEST_PLACEHOLDER_xxxxxxxxxxxx',
      STRIPE_RK_TEST: 'rk_test_TEST_PLACEHOLDER_xxxxxxxxxxxx',
      // Slack
